<x-layout>
  ...
  <div class="flex flex-col items-center justify-center mt-10 mx-auto w-full lg:w-1/2 p-8 bg-white shadow-lg rounded-lg">
      <h2 class="text-center text-2xl font-bold text-red-600 mb-6">Register</h2>
      <form action="{{ url('/store') }}" method="POST" class="w-full">
          ...
          <button type="submit" class="w-full py-2 px-4 bg-red-600 text-white rounded-md hover:bg-red-700 transition duration-300">Register</button>
      </form>
  </div>
